...
public interface StatesMachineConstants {

	public static final String DIRECT_RESPONSE_LIST ="directResponseList";
	...
	public static final String CUSTOM_SIMPLE_MESSAGE="simpleMessageCustomizer";
}
